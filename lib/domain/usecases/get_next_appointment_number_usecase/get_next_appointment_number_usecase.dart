...
class GetNextAppointmentNumberUsecase implements UseCase<DataState<NextAppointmentNumberModel>,Params>{
  @override
  Future<DataState<NextAppointmentNumberModel>> call({Params ? params}) async {
    final branchId = await sl<SharedPrefManager>().getBranchId();
    return sl<AppointmentRepository>().getNextAppointmentNumber(params!.doctorId, params.date, branchId);
  }
